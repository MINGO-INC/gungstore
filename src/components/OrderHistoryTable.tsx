        ...
        <Table className="min-w-[700px]">
          <TableHeader className="bg-muted/50">
            <TableRow>
              ...
              <TableHead className="text-right font-semibold text-accent-foreground">Comm. (30%)</TableHead>
              <TableHead className="text-right font-semibold text-secondary-foreground bg-secondary/5">Ledger (70%)</TableHead>
