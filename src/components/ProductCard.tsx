    ...
    >
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="mt-auto space-y-4">
          ...
          <Button 
            onClick={handleAdd}
            className="w-full bg-[oklch(0.48_0.18_264)] hover:bg-[oklch(0.43_0.18_264)] text-white font-semibold shadow-sm border-t border-white/10 transition-all active:scale-[0.98] cursor-pointer"
          >
